...
const About = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', justifyContent:'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.7)', width: '100vw', height: '100vh'}}>

      <section className='about'>

        <Link to='/' style={{backgroundColor: 'blue'}}><FontAwesomeIcon icon={faArrowLeft} style={{color: dark ? "black" : 'whitesmoke'}} /></Link>

        <div className="about-container" style={{backgroundColor: dark ? '#121212' : 'whitesmoke'}}>
          ...
          <p className='about-para lastpara'>
