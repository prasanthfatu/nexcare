        ...
        <form className='patientform'>
          ...
          {/* Name */}
           <div style={{position: 'relative', backgroundColor: dark ? '#0D0D0D' : '#fff', width: '100%', height: '100px'}}>
            ...
            <label style={{...(dark ? styles.darklabel : styles.lightlabel), top: (isFocused.focusName || patientName !== '') ? '20px' : '48px', left: (isFocused.focusName || patientName !== '') ? '30px' : '30px', fontSize: (isFocused.focusName || patientName !== '') ? '13px' : '16px', pointerEvents: 'none'}}>
              Patient Name
            </label>
          ...
          {/* Gender */}
            ...
            <label style={{...(dark ? styles.darklabel : styles.lightlabel), top: (isFocused.focusGender || gender !== '') ? '20px' : '48px', left: (isFocused.focusGender || gender !== '') ? '30px' : '30px', fontSize: (isFocused.focusGender || gender !== '') ? '13px' : '16px', pointerEvents: 'none'}}>
              Gender
            </label>
